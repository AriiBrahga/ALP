...
int main(void) {
  ...
  // Aqui é pedido se deseja utilizar o programa como ADM ou Usuario.
  cout << "Você deseja executar a maquina como: \n1 - Administrador. \n2 - Usuario." << endl;
  cin >> escolha;
  while (escolha >=0){
    //esses comandos são para o uso do Administrador
    if (escolha == 1){
      cout << "Digite a senha: ";
      cin >> senha;
      if (senha == 12345){
    ...
    //Comandos do para o uso do Usuario
      ...
      //Aqui pede o tipo de produto que o usuario quer, no caso suco ou refri ou chips.
        if (produto == 1){
          cout << "Os sucos disponiveis são: \n1 - Suco de Laranja. \n2 - Suco de Caju. \n3 - Suco de Maracuja \n4 - Suco de uva" << endl;
          cin >> suco;
          //O suco escolhido é removido de sua quantidade original. 
          if (suco == 1){
            qtd_lar--;
          }
          else if(suco == 2){
        ...
        if (produto == 2){
          ...
          cin >> chips;
          //O chips escolhido é removido de sua quantidade original. 
          if (chips == 1){
            qtd_chips_queijo--;
          }
          else if (chips == 2){
        ...
        if (produto == 3){
          cout << "Os refrigerantes disponiveis são: \n1 - Coca-cola \n2 - Guarana \n3 - Fanta Laranja" << endl;
          cin >> refri;
          //O refri escolhido é removido de sua quantidade original. 
          if(refri == 1){
            qtd_coca--;
          }
          else if(refri == 2){
        ...
        if(escolha_1 == 2) { // Aqui caso o usario não deseje mais alguma coisa o programa é encerrado    
          totalfaturado += totalapagar; // incrementa o faturamento da maquina
          cout << "Ok, o total a pagar é: " << totalapagar << endl;
    ...
    cout << "Você deseja continuar executando a maquina: \n1 - Sim. \n2 - Nao." << endl;
    cin >> escolha_2;
    if (escolha_2 == 1){
